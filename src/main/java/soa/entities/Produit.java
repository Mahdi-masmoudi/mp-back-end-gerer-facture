...
public class Produit {
	...
	public Produit(String designation, String image, double prix, int quantite, Date dateAchat, Categorie categorie) {
		super();
	...
	public Produit(String designation,String image, double prix, int quantite, Date dateAchat) {
		super();
		this.designation = designation;
		this.image = image;
		this.prix = prix;
